    ...
    if (props.config.rag.enabled) {
      ...
      if (
        ...
        NagSuppressions.addResourceSuppressionsByPath(
          this,
          [
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/CodeBuildRole/DefaultPolicy/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/OnEventHandler/ServiceRole/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/IsCompleteHandler/ServiceRole/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-onEvent/ServiceRole/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-onEvent/ServiceRole/DefaultPolicy/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-isComplete/ServiceRole/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-isComplete/ServiceRole/DefaultPolicy/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-onTimeout/ServiceRole/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/framework-onTimeout/ServiceRole/DefaultPolicy/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/waiter-state-machine/Role/DefaultPolicy/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/Provider/waiter-state-machine/Resource`,
            `/${this.stackName}/RagEngines/SageMaker/Model/MultiC08BA/SageMakerExecutionRole/DefaultPolicy/Resource`,
          ],
          [
            {
              id: "AwsSolutions-SF1",
